...
/**
 * Cookiebot (often injected via GTM) sets overflow:hidden on html/body until consent.
 * If the script errors — e.g. domain not authorized in Cookiebot Manager — the banner may
 * never show and the page stays unscrollable. This only clears the lock when no banner is visible.
 */
